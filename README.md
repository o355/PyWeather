...
I've reported an issue to the project on GitHub, and hopefully things will get solved. This doesn't affect PyWeather 0.6.2 beta, or any indev code from commit `bda1180` and earlier.
