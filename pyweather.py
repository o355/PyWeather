...
#<--- Exit PyWeather is above | Updater is below --->
        ...
        # I have decided to rewrite the PyWeather Updater v2. The now old v2 updater was too complex, and overambitious.
        # These features will now be removed from the new v2 updater:
        # - Branches have been scrapped entirely. RCs and betas would increase release time.
        # - 2 checksum checks. MD5 & SHA1 checks are scrapped. SHA256 checks will be the only available check for futureproofing.
        # - The old updater method will be the old updater and not check for hashsums
        # Other smaller features will be removed. These new features will be added, however:
        # - Total depreciation tag for PyWeather
        # - Being able to download the dirless .zip on its own

        # The new v2 updater will be complete when the remaining smaller features scheduled for fixing & coding are complete.

        print("The new updater is being completely rewritten.")
        ...
        if (almanac_prefetched == False or time.time() - cachetime_almanac >= cache_almanactime
            ...
            try:
                ...
                try:
                    ...
                    print("")
                    logger.warning("Couldn't contact Wunderground's API! Is the internet offline?")
                    print(
                        Fore.RED + Style.BRIGHT + "When fetching the almanac data from Wunderground, PyWeather ran into",
        ...
        if (hurricanePrefetched == False or refresh_hurricanedataflagged == True or time.time() - cachetime_hurricane >= cache_hurricanetime):
            ...
            try:
                ...
                try:
                    ...
                    print("")
                    print(
                        Fore.RED + Style.BRIGHT + "When attempting to fetch hurricane data, PyWeather ran into an error.",
        ...
        for data in hurricane_json['currenthurricane']:
            ...
            if hurricanenearestcity_enabled is True:
                ...
                try:
                    ...
                    nearestJSON = requests.get(nearesturl_https)
            ...
            if favconfig_menuinput == "1":
                ...
                if favloc_manualinputLower.find("pws:") == 0 or favloc_manualinputLower.find("ps:") == 0:
                    ...
                    if airportvalidate_input == "yes":
                        ...
                        try:
                            airportvalidateJSON = requests.get(airportvalidate_url_https)
                            ...
                            try:
                                ...
                                print("")
                                print(
                                    Fore.YELLOW + Style.BRIGHT + "Sorry, we couldn't query Wunderground to get extra data about the airport.",
                                ...
                                if airportvalidate_invalidinput == "yes":
                                    print(
                                        Fore.YELLOW + Style.BRIGHT + "Still adding the airport as a favorite location.")
                                elif airportvalidate_invalidinput == "no":
                                    print(Fore.YELLOW + Style.BRIGHT + "Not adding the airport as a favorite location.")
                                    continue
                                else:
                                    print(
                                        Fore.YELLOW + Style.BRIGHT + "Could not understand your input, but still adding the airport as",
